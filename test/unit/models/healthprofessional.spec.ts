    ...
    describe('fromJSON()', () => {
        context('when pass a complete json', () => {
            it('should return a complete admin model', () => {
                ...
                assert.propertyVal(result, 'total_pilot_studies', DefaultEntityMock.HEALTH_PROFESSIONAL.total_pilot_studies)
                assert.propertyVal(result, 'total_patients', DefaultEntityMock.HEALTH_PROFESSIONAL.total_patients)
